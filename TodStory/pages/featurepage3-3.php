...
<head>
    ...
    <link rel="stylesheet" href="../css/featurepage3-3.css" />
    <title>Feature Page 3.3 (Berhenti Berlangganan)</title>
</head>
...
<body>
    ...
    <main>
        <div class="directory">
            ...
            <p class="dirpcs">></p>
            <a class="dirpcs" href="featurepage1.php">FAQ</a>
            <p class="dirpcs">></p>
            <a class="dirpcs" href="featurepage3.php">Subscribe</a>
            <p class="dirpcs">></p>
            <a class="dirpcs" href="#">Bagaimana cara berhenti berlangganan di Tod's Story</a>
        </div>
        <div class="berhentiberlangganan">
            <p><span class="berhentiberlanggananjudul">Bagaimana cara berhenti berlangganan di Tod's Story?</span></p>
            <div class="berhentiberlanggananisi">
                <div class="langkahberhenti">
                    <p class="tekslangkah">1. Klik profil</p>
                    <img src="../assets/icons/user.png" alt="" class="profilicon" />
                </div>
                <div class="langkahberhenti">
                    <p class="tekslangkah">2. Pilih Berhenti berlangganan</p>
                    <p class="berhentiberlanggananbutton">Berhenti berlangganan</p>
                </div>
            </div>
        </div>
        <div class="virtualassistant">
            <div class="va_box">
                ...
                <article class="va_text">
                    <a href="featurepage2.php" class="blacklink">
                        <p class="va_intro">
